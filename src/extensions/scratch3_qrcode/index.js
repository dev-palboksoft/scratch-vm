...
const Message = {
    ...
    qrStart : {
        ...
        'ko': '스캔 시작 [INPUT]',
        'zh-cn': '开始扫描 [INPUT]',
        'de': 'Scannen starten [INPUT]',
        'es': 'Empezar a escanear [INPUT]',
        'ru': 'Начать сканирование [INPUT]',
        'sr': 'Započnite skeniranje [INPUT]'
    },
    qrCameraInput : {
        'ja': 'カメラ',
        'ja-Hira': 'カメラ',
    ...
    qrStop : {
        ...
        'ko': '스캔 중지',
        'zh-cn': '停止扫描',
        'de': 'Stoppen Sie den Scanvorgang',
        'es': 'Detener el escaneo',
        'ru': 'Остановить сканирование',
        'sr': 'Zaustavite skeniranje'
    },
    qrScanning : {
        'ja': '読み取り中',
        'ja-Hira': 'よみとりちゅう',
    ...
    qrSetInterval : {
        ...
        'ko': '스캔 간격 설정 [INTERVAL] 초',
        'zh-cn': '设置扫描间隔 [INTERVAL] 秒',
        'de': 'Scanintervall einstellen [INTERVAL] sec',
        'es': 'establecer el intervalo de escaneo [INTERVAL] seg',
        'ru': 'установить интервал сканирования [INTERVAL] сек',
        'sr': 'podesite interval skeniranja [INTERVAL] sek'
    },
    qrData : {
        'ja': '読み取り結果',
        'ja-Hira': 'よみとりけっか',
    ...
    qrASCII : {
        ...
        'ko': '글자 [INDEX] ASCII 데이터 코드',
        'zh-cn': '字母 [INDEX] 数据的ASCII码',
        'de': 'Buchstabe [INDEX] ASCII-Datencode',
        'es': 'letra [INDEX] código de datos ASCII',
        'ru': 'буква [INDEX] Код ASCII данных',
        'sr': 'slovo [INDEX] ASCII kod podataka'
    },
    qrReset : {
        'ja': '読み取り結果を消す',
        'ja-Hira': 'よみとりけっかをけす',
    ...
    qrSetCameraTransparency : {
        ...
        'ko': '카메라 투명도 설정 [TRANSPARENCY]',
        'zh-cn': '将相机透明度设置为 [TRANSPARENCY]',
        'de': 'Stellen Sie die Kameratransparenz auf [TRANSPARENCY]',
        'es': 'establecer la transparencia de la cámara en [TRANSPARENCY]',
        'ru': 'установить прозрачность камеры на [TRANSPARENCY]',
        'sr': 'postavi prozirnost kamere na [TRANSPARENCY]'
    }
};
